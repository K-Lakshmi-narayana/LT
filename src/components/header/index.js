...
class Header extends Component {
    state = {"modalIsOpen": false, "isLogin": false}
    ...
    componentDidMount() {
        ...
        token === null ? this.setState({"isLogin": false}) : this.setState({"isLogin": true})
    }
    ...
    render() {
        const {modalIsOpen, isLogin} = this.state
        const customStyles = {
            content: {
                top: '50%',
                left: '50%',
                    ...
                    <div className='nav-header'>
                        ...
                        <div className='d-flex align-items-center'>
                            ...
                            <div className="navbar-logout">
                                ...
                                <button className='logout-btn logout-btn-lg' onClick={this.onLogin}>Login</button>}
